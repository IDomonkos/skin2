...
var slitherplus_skins = {
   skins: [
      ...
      {// ID8
         body:   [11, 24, 24, 9, 24, 24],
         bulb:   {id: 'mg11SfC', width: 151, height: 79, x: -40, y: -39.5, scale: 0.44, alpha: 1, antenna_length: 20, antenna_border: '#000000', antenna_color: '#ffffff'},
         extras: {er: 7.2, ec: '#000000', eca: 1, ppc: '#000000', swell: 0.04}
      },
{// CRYSTAL
         body:   [23],
...
skin.js
Domonkos Irlanda (irlanda.domonkos@gmail.com)
skin.js megjelenítése.
